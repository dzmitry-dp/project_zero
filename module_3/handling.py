...
class ConfigWrapper:
    def __init__(self, data):
        ...
        self.processing_city() # после cuisine style и price range, т.к. заполняем средним по городам
    ...
    def processing_city(self):
        ...
        # рестораны в не больших городах 1
    ...
    def processing_cuisine_style(self):
        ...
        for idx in self.final_data[self.final_data['Amount_Cuisine_Style'].isnull()].index:
            self.final_data.at[idx, 'Amount_Cuisine_Style'] = round(self.final_data['Amount_Cuisine_Style'][self.final_data['City'] == self.final_data['City'].iloc[idx]].mean())
    ...
    def processing_price_range(self):
        ...
        for idx in self.final_data[self.final_data['Price Range'].isnull()].index:
            self.final_data.at[idx, 'Price Range'] = round(self.final_data['Price Range'][self.final_data['City'] == self.final_data['City'].iloc[idx]].mean())
